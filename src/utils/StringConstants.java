  ...
  \u001B[37m/ssssssssssss\u001B[31m      ++++      \u001B[37mssssssssssss/\u001B[0m  
   ...
   \u001B[37m.sssssssssssss\u001B[32m     ++++++     \u001B[37mssssssssssssss.\u001B[0m 
    ...
    public static final String MAIN_MENU = LOGO_2 + """
                         ...
                         ╠════════╬══════════════════════════════════════════╣
                         ║ \u001B[33m  4   \u001B[0m ║ Manage Nurses                            ║
                         ╠════════╬══════════════════════════════════════════╣
                         ║ \u001B[33m  5   \u001B[0m ║ Manage Appointments                      ║
                         ╠════════╬══════════════════════════════════════════╣
                         ║ \u001B[33m  6   \u001B[0m ║ Manage Medical Records                   ║
                         ╠════════╬══════════════════════════════════════════╣
                         ║ \u001B[33m  7   \u001B[0m ║ Search/View Data                         ║
                         ╠════════╬══════════════════════════════════════════╣
                         ║ \u001B[33m  8   \u001B[0m ║ Analytics Dashboard                      ║
                         ╠════════╬══════════════════════════════════════════╣
                         ║ \u001B[33m  9   \u001B[0m ║ Change Password                          ║
                         ╠════════╬══════════════════════════════════════════╣
                         ║ \u001B[33m  0   \u001B[0m ║ Exit                                     ║
                         ╚════════╩══════════════════════════════════════════╝
                         """;
    ...
    public static final String NURSE_SAMPLE_DATA = """
                ╔════════════════════════════════════════════════════════════════════════════════════╗
                ║ Example Input Format for Adding a Nurse                                            ║
                ╠══════════════════════════╬═════════════════════════════════════════════════════════╣
                ║ Field                    ║ Example Value                                           ║
                ╠══════════════════════════╬═════════════════════════════════════════════════════════╣
                ║ Name                     ║ Sarah Johnson                                           ║
    ...
    public static final String NURSE_MENU = """         
                         ╔═══════════════════ Manage Nurses ══════════════════╗
                         ║ Option ║ Description                                ║
                         ╠════════╬════════════════════════════════════════════╣
                         ║ \u001B[33m  1   \u001B[0m ║ Add Nurse                                  ║
                         ╠════════╬════════════════════════════════════════════╣
                         ║ \u001B[33m  2   \u001B[0m ║ Remove Nurse                               ║
                         ╠════════╬════════════════════════════════════════════╣
                         ║ \u001B[33m  3   \u001B[0m ║ Update Nurse Details                       ║
                         ╠════════╬════════════════════════════════════════════╣
                         ║ \u001B[33m  4   \u001B[0m ║ View Nurses                                ║
                         ╠════════╬════════════════════════════════════════════╣
                         ║ \u001B[33m  0   \u001B[0m ║ Back to Main Menu                          ║
                         ╚════════╩════════════════════════════════════════════╝
                         """;
    ...
    public static final String SEARCH_VIEW_MENU = """
                         ...
                         ╠════════╬════════════════════════════════════════════╣
                         ║ \u001B[33m  3   \u001B[0m ║ Search Nurses                              ║
                         ╠════════╬════════════════════════════════════════════╣
                         ║ \u001B[33m  4   \u001B[0m ║ Search Appointments                        ║
                         ╠════════╬════════════════════════════════════════════╣
                         ║ \u001B[33m  5   \u001B[0m ║ Search Rooms                               ║
                         ╠════════╬════════════════════════════════════════════╣
                         ║ \u001B[33m  0   \u001B[0m ║ Back to Main Menu                          ║
                         ╚════════╩════════════════════════════════════════════╝
                         """;
